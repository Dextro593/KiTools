...
#Written by: Bryan Herrera (Dextro)
#Facebook: https://www.facebook.com/daniel.san.01.11
...
def info():
	...
	time.sleep(0.2)
	print("{0}[AUTOR]:{1} BRYAN HERRERA / DEXTRO\n\n").format(RED, DEFAULT)
	time.sleep(0.2)
	print("{0}[FACEBOOK]:{1} https://www.facebook.com/daniel.san.01.11\n\n").format(RED, DEFAULT)
	time.sleep(0.2)
	os.system('clear')
	banner()
...
def banner():
	...
	print '{}	╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝  '.format(RED).center(93)
        ...
        print '{}   	   "El que no conoce mi historia, esta condenado a REPETIRLA"'.format(BOLD)
	print '{}    								BY: DEXTRO'.format(BOLD)
...
def options():
	...
	if option == 1:
		...
		os.system("firefox https://www.facebook.com/daniel.san.01.11")
		os.system('clear')
		banner(), menu(), options()	
